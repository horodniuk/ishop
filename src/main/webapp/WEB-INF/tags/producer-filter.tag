...
<%@ attribute name="searchForm" required="true" type="com.jshop.form.SearchForm"%>
...
<div class="panel-body producers">
    ...
    <c:forEach var="producer" items="${producers }">
        <div class="form-group">
            <div class="checkbox">
                <label><input type="checkbox" name="producer"
                              value="${producer.id }" ${searchForm.producers.contains(producer.id) ? 'checked' : '' }
                              class="search-option">
