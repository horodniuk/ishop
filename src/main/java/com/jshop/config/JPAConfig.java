...
import com.jshop.repository.SearchProductRepositoryImpl;
...
@EnableJpaRepositories(value = "com.jshop.repository", repositoryBaseClass = SearchProductRepositoryImpl.class)
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        entityManagerFactory.setPackagesToScan("com.jshop.entity");
